...
![Cybersecurity](https://img.shields.io/badge/Focus-Cybersecurity-2EA043?style=for-the-badge)
...
### ☁️ AWS Secure Enterprise Network

Designed and implemented a segmented AWS network using a VPC, public and private subnets, EC2 instances, route tables, an internet gateway, and Security Group–to–Security Group access.
...
A multi-service survey platform consisting of a Node.js student application, a PHP and Apache administration application, and a shared MySQL database.
...
### Building consistently—one project, command, and deployment at a time.
